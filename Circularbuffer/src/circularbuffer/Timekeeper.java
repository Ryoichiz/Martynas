...
public class Timekeeper {
    ...
    private String antraštė = "  size(*k) ";
    ...
    private void summary() throws InterruptedException {
        ...
        sb.append(String.format("       Base test time %8.3f seconds", totTime)).append("\n");
        sb.append(String.format("    Calculated test time %8.3f seconds", sumTime)).append("\n");
        sb.append(String.format("    that is %5.1f%% makes up helping works",
                (totTime - sumTime) / totTime * 100)).append("\n");
        sb.append("\n");
        sb.append("Normalized (relative) time table\n");
